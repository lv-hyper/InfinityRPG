...
{
    [Serializable]
    [CreateAssetMenu(fileName = "Data", menuName = "ScriptableObjects/Skills/Active/Regenerate Mana Skill")]
    public class RegenerateManaSkill : ActiveSkill
    {
        [SerializeField] float percentage;
        public override void OnActive(BattleInstance.AbstractInstance target)
        {
            target.RegenerateMana((System.Numerics.BigInteger)((double)target.GetMaxHealth() * percentage));
        }
        ...
        public override string GetLongDescription(long stack)
        {
            ...
            longDesc += String.Format("This skill give you Mana.\nAmount : {0}% of your total mana\n",
                percentage * 100
            );
